    ...
    fn prompt(
        ...
        match self {
            ...
            Self::Phi4Reasoning(m) => {
                spawn_stream_phi4_reasoning(m.clone(), prompt, params.clone())
            }
        }
    }
}
...
impl_text_to_text_spawn!(
    spawn_stream_kimi_k2,
    crate::capability::text_to_text::kimi_k2::CandleKimiK2Model,
    LoadedKimiK2Model
);
impl_text_to_text_spawn!(
...
impl_text_to_text_spawn!(
    spawn_stream_phi4_reasoning,
    crate::capability::text_to_text::phi4_reasoning::CandlePhi4ReasoningModel,
