# DECOMP_038: Decompose `bert.rs`

**File:** `packages/candle/src/capability/text_embedding/bert.rs`  
**Current Size:** 679 lines  
**Module Area:** capability / text_embedding

## OBJECTIVE

Decompose the monolithic `bert.rs` (679 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/capability/text_embedding/bert.rs` to identify:
...
- [ ] `bert.rs` is reduced to < 300 lines (ideally much less)
...
- File size (679 lines) indicates high complexity or multiple responsibilities
