...
Decompose the monolithic `entity.rs` (909 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/memory/graph/entity.rs` to identify:
...
- [ ] `entity.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **memory / graph** module area
- File size (909 lines) indicates high complexity or multiple responsibilities
