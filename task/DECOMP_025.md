# DECOMP_025: Decompose `commands.rs`

**File:** `packages/candle/src/domain/chat/commands/types/commands.rs`  
**Current Size:** 818 lines  
**Module Area:** domain / chat / commands / types

## OBJECTIVE

Decompose the monolithic `commands.rs` (818 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/domain/chat/commands/types/commands.rs` to identify:
...
- [ ] `commands.rs` is reduced to < 300 lines (ideally much less)
...
### File Location
`packages/candle/src/domain/chat/commands/types/commands.rs`

### Key Considerations
- This file is part of the **domain / chat / commands / types** module area
- File size (818 lines) indicates high complexity or multiple responsibilities
