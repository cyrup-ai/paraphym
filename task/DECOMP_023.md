# DECOMP_023: Decompose `core.rs`

**File:** `packages/candle/src/domain/chat/templates/core.rs`  
**Current Size:** 878 lines  
**Module Area:** domain / chat / templates

## OBJECTIVE

Decompose the monolithic `core.rs` (878 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/domain/chat/templates/core.rs` to identify:
...
- [ ] `core.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **domain / chat / templates** module area
- File size (878 lines) indicates high complexity or multiple responsibilities
