# DECOMP_047: Decompose `semantic.rs`

**File:** `packages/candle/src/memory/core/systems/semantic.rs`  
**Current Size:** 600 lines  
**Module Area:** memory / core / systems

## OBJECTIVE

Decompose the monolithic `semantic.rs` (600 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/memory/core/systems/semantic.rs` to identify:
...
- [ ] `semantic.rs` is reduced to < 300 lines (ideally much less)
...
### File Location
`packages/candle/src/memory/core/systems/semantic.rs`

### Key Considerations
- This file is part of the **memory / core / systems** module area
- File size (600 lines) indicates high complexity or multiple responsibilities
