# DECOMP_044: Decompose `flux_schnell.rs`

**File:** `packages/candle/src/capability/text_to_image/flux_schnell.rs`  
**Current Size:** 651 lines  
**Module Area:** capability / text_to_image

## OBJECTIVE

Decompose the monolithic `flux_schnell.rs` (651 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/capability/text_to_image/flux_schnell.rs` to identify:
...
- [ ] `flux_schnell.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **capability / text_to_image** module area
- File size (651 lines) indicates high complexity or multiple responsibilities
