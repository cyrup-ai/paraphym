# DECOMP_045: Decompose `phi4_reasoning.rs`

**File:** `packages/candle/src/capability/text_to_text/phi4_reasoning.rs`  
**Current Size:** 609 lines  
**Module Area:** capability / text_to_text

## OBJECTIVE

Decompose the monolithic `phi4_reasoning.rs` (609 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/capability/text_to_text/phi4_reasoning.rs` to identify:
...
- [ ] `phi4_reasoning.rs` is reduced to < 300 lines (ideally much less)
...
- File size (609 lines) indicates high complexity or multiple responsibilities
