# DECOMP_021: Decompose `validation.rs`

**File:** `packages/candle/src/domain/chat/commands/validation.rs`  
**Current Size:** 890 lines  
**Module Area:** domain / chat / commands

## OBJECTIVE

Decompose the monolithic `validation.rs` (890 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/domain/chat/commands/validation.rs` to identify:
...
- [ ] `validation.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **domain / chat / commands** module area
- File size (890 lines) indicates high complexity or multiple responsibilities
