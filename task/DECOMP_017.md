# DECOMP_017: Decompose `document.rs`

**File:** `packages/candle/src/builders/document.rs`  
**Current Size:** 915 lines  
**Module Area:** builders

## OBJECTIVE

Decompose the monolithic `document.rs` (915 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/builders/document.rs` to identify:
...
- [ ] `document.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **builders** module area
- File size (915 lines) indicates high complexity or multiple responsibilities
