# DECOMP_014: Decompose `cognitive_worker.rs`

**File:** `packages/candle/src/memory/core/cognitive_worker.rs`  
**Current Size:** 1,006 lines  
**Module Area:** memory / core

## OBJECTIVE

Decompose the monolithic `cognitive_worker.rs` (1,006 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/memory/core/cognitive_worker.rs` to identify:
...
- [ ] `cognitive_worker.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **memory / core** module area
- File size (1,006 lines) indicates high complexity or multiple responsibilities
