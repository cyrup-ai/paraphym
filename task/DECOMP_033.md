# DECOMP_033: Decompose `gte_qwen.rs`

**File:** `packages/candle/src/capability/text_embedding/gte_qwen.rs`  
**Current Size:** 711 lines  
**Module Area:** capability / text_embedding

## OBJECTIVE

Decompose the monolithic `gte_qwen.rs` (711 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/capability/text_embedding/gte_qwen.rs` to identify:
...
- [ ] `gte_qwen.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **capability / text_embedding** module area
- File size (711 lines) indicates high complexity or multiple responsibilities
