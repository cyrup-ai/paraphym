...
Decompose the monolithic `types.rs` (1,970 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/domain/memory/cognitive/types.rs` to identify:
...
### Key Considerations
- This file is part of the **domain / memory / cognitive** module area
- File size (1,970 lines) indicates high complexity or multiple responsibilities
