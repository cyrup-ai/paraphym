# DECOMP_035: Decompose `models.rs`

**File:** `packages/candle/src/core/generation/models.rs`  
**Current Size:** 688 lines  
**Module Area:** core / generation

## OBJECTIVE

Decompose the monolithic `models.rs` (688 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/core/generation/models.rs` to identify:
...
- [ ] `models.rs` is reduced to < 300 lines (ideally much less)
...
### Key Considerations
- This file is part of the **core / generation** module area
