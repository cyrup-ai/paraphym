...
Decompose the monolithic `chat.rs` (807 lines) into smaller, focused, maintainable modules while preserving all existing functionality.
...
Read and analyze `packages/candle/src/builders/agent_role/chat.rs` to identify:
...
### File Location
`packages/candle/src/builders/agent_role/chat.rs`

### Key Considerations
- This file is part of the **builders / agent_role** module area
- File size (807 lines) indicates high complexity or multiple responsibilities
